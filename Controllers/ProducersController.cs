...
namespace MobileAvailability.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public ProducersController(MobileAvailabilityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Naziv")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naziv")] Producer producer)
        {
            if (id != producer.Id)
            {
                return NotFound();
